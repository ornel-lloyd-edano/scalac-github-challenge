...
import com.scalac.github_challenge.util.{Configs, ExecutionContexts}

object Main extends App {
  implicit val system = ActorSystem("scalac-github-challenge")
  val controller = new Controller(new GitHubContributionService(ExecutionContexts, Configs))
